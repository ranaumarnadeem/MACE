...
for pico's tile, and a silicon BIST self-clear race that discarded pico's first memory writes. With
all three fixed, PicoRV32 \textbf{passes} under Verilator (\code{Simulation -> PASS (HIT GOOD
...
and added a third core, and the loop passed 2x2 and 4x4 meshes of both Ariane and PicoRV32.
